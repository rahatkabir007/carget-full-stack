        ...
        <>
            <div className="register-section">
                ...
                <ThemeProvider theme={theme}>
                    <Container component="main" maxWidth="xs" style={{ backgroundColor: '#F9E4C8', border: '10px solid #f18d4d', borderRadius: "10px", marginTop: "40px", padding: "5px", marginBottom: "50px" }} className={!isLoading ? "register-form" : "register-loading-form"}>
                        <CssBaseline />
                        <Box
                            sx={{
                                margin: 3,
