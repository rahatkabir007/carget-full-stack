...
const PlaceOrder = () => {
    ...
    const onSubmit = (data) => {
        ...
        console.log(data);
        axios.post('https://carget-full-stack-server-production.up.railway.app/placeOrders', data)
            .then(res => {
    ...
    useEffect(() => {
        fetch(`https://carget-full-stack-server-production.up.railway.app/selectedproduct/${productId}`)
            .then(res => res.json())
